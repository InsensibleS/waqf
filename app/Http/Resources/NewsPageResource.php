    ...
    public function toArray($request)
    {
        ...
        return [
            'news' => [
                ...
                'img' => \config('custom.backendUrl') . \config('custom.storagePath') . $this->news->image,
                ...
                'comments' => CommentResource::collection($this->news->newsComments->where('answer_to', null)->sortByDesc('id'))
            ],
