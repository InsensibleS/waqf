    ...
    public function run()
    {
        DB::table('news')->insert([
            ...
            [
                ...
                'full_description' => '<p>RIYADH: From one generation to another, history is told and retold. But with time, large fragments are lost, so a Riyadh-based research center is helping preserve some of Saudi Arabia&rsquo;s most important historical facts.
...
Speaking to Arab News, Darah spokesman Sultan Alawairdhi said the center&rsquo;s founding is in line with the government&rsquo;s policy to preserve its history. He added that it is of vital importance to ensure that historical narratives are accessible to all by using knowledge and historical facts told by the elderly who lived through major historical events that shaped the Kin<img src="http://127.0.0.1:8000/storage/images/news/whatsapp_image_2020-12-23_at_6.19.32_pm.jpg" style="width: 530px;" class="fr-fic fr-fil fr-dii">gdom.<img src="http://127.0.0.1:8000/storage/images/news/2168371-596081543.jpg" style="width: 601px;" class="fr-fic fr-dii fr-fir"></p>',
                'publication_date' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'full_description' => '<h4>RIYADH: The King Abdul Aziz and His Companions Foundation for Giftedness and Creativity (Mawhiba) on Tuesday signed an agreement with the Saudi Authority for Intellectual Property (SAIP) joining the National Network of Technology and Innovation Support Centers (TISC). The TISC enables innovators to protect and manage their intellectual property rights. The deputy secretary-general of Mawhiba, Basil Al-Sadhan, said the foundation seeks to create an environment that motivates talent and&nbsp;<img src="http://127.0.0.1:8000/storage/images/news/pic04578_lw.jpg" style="width: 271px;" class="fr-fic fr-dii fr-fil">encourages the youth to pursue their passion for science and become future leaders.<p><br></p><img src="http://127.0.0.1:8000/storage/images/news/151228-saudi-king-salman.jpg" style="width: 275px;" class="fr-fic fr-fir fr-dii"><br>Al-Sadhan said Mawhiba found the TISC initiative launched by the SAIP helpful in achieving its core mission. &ldquo;TISC allows Mawhiba to access and employ technical and scientific expertise, provide assistance in searching and analyzing intellectual and technical property databases and obtain information on patents.&rdquo; By signing the deal, Mawhiba has bec<div class="fr-img-space-wrap"><p class="fr-img-space-wrap2">&nbsp;</p></div>ome one of the 26 entities that are part of SAIP&rsquo;s national network. SAIP aims to organize, support, sponsor, protect and promote intellectual property in the Kingdom in accordance with global best practices. Al-Sadhan said by joining the network Mawhiba has now gained access to other support services that suit the needs of its students and employees. &ldquo;The most important of these services is providing guidance on intellectual property rights such as the use of patents, industrial designs, trademarks, and copyrights,&rdquo; he said. SAIP Vice President Sami Al-Sudais welcomed Mawhiba aboard TISC, which enables users to acquire the technical skills needed to search intellectual property databases.</h4>',
                'publication_date' => date('Y-m-d H:i:s'),
...
<p><img class="fr-dii fr-fic fr-fil" src="http://127.0.0.1:8000/storage/images/news/eng._anas_mohammed_seirafi_copy.png" style="float:left; margin-left:10px; margin-right:10px; width:215px" /></p>
